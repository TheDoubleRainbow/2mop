...
router.post('/', _requireAuth2.default, function (_ref3, res) {
	...
	if (user.type == "company") {
		var hakaton = new _hakaton2.default({ name: body.name, avatar: body.avatar, description: body.description, organizerId: user._id, requiredSkills: body.requiredSkills });
